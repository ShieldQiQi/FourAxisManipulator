	...
	, qnode(argc,argv)
{
 ...
 //   }
    ...
    ui.CtrlPanel->setGeometry(10,10,600,600);
...
void MainWindow::on_button_connectRos_clicked() 
{
    if ( !qnode.init() ) {
	    showNoMasterMessage();
    } else {
...
{    
    qnode.angleArray.data.at(0) = ui.axisOne->text().toFloat();
    qnode.angleArray.data.at(1) = ui.axisTwo->text().toFloat();
    qnode.angleArray.data.at(2) = ui.axisThree->text().toFloat();
...
void MainWindow::ReadSettings() {
    QSettings settings("Qt-Ros Package", "qtui");
