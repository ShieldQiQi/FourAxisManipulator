...
public:
    ...
    inverseSolutionKiller(double a_1=0.016,double a_2=0.103,double a_3=0.097,double h_1=0.183,double h_2=0.09,double x_1=0.018);
...
bool inverseSolutionKiller::getThetaArray(double x,double y)
{
    ...
    angleArray[2] = acos(((h2-h1)*(h2-h1)+q*q-a2*a2-a3*a3)/(2*a2*a3));

    double s2 = (-q-(h1-h2)*(a3*cos(angleArray[2])+a2)/a3/sin(angleArray[2]))/
            (a3*sin(angleArray[2])+(a3*cos(angleArray[2])+a2)*(a3*cos(angleArray[2])+a2)/(a3*sin(angleArray[2])));
    double c2 = (-(h1-h2)+q*(a3*cos(angleArray[2])+a2)/a3/sin(angleArray[2]))/
            (a3*sin(angleArray[2])+(a3*cos(angleArray[2])+a2)*(a3*cos(angleArray[2])+a2)/(a3*sin(angleArray[2])));
